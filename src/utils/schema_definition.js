...
const AddCharacterSchema = Joi.object({
	...
	characterId: Joi.number().required().messages({
		"number.base": `characterId should be a number.`,
		"number.empty": `characterId is required.`,
		"any.required": `characterId is required.`,
	}),
});
